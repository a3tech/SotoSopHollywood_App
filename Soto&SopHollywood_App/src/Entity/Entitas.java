...
public class Entitas {
    ...
    private String username, password, tgl;
    private String id_wilayah, nama_wilayah, alamat, node;
    private String kd_menu, nama_menu;
    private String meja, nonota, id_pelanggan, jabatan;
    private int tarif, harga_menu, jml ;
    private static String karyawan, idkaryawan;
    ...
    public static void setIdkaryawan(String aIdkaryawan) {
    ...
    public static void setKaryawan(String Karyawan) {
        karyawan = Karyawan;
    }
    ...
    public String getKd_menu() {
        return kd_menu;
    }

    public void setKd_menu(String kd_menu) {
        this.kd_menu = kd_menu;
    }
